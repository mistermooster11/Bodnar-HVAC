  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__top">
        <div className="footer__brand">
          ...
          <p className="footer__desc">
            <strong>Bodnar Heating &amp; Air Conditioning, Inc.</strong> — Family-owned HVAC specialists serving the Mid-Peninsula since 1976. Repair-first philosophy, owner-operated, no commission sales reps.
          </p>
          <p className="footer__desc" style={{ marginTop: "0.5rem", fontSize: "0.9em" }}>
            1251 Fifth Ave., Redwood City, CA 94063<br />
            <a href="tel:+16503684408" style={{ color: "inherit" }}>(650) 368-4408</a> &nbsp;|&nbsp;
            <a href="mailto:info@bodnarhvac.com" style={{ color: "inherit" }}>info@bodnarhvac.com</a>
          </p>
      ...
      <div className="footer__bottom">
        <p className="footer__copyright">Copyright 2025 Bodnar Heating &amp; Air Conditioning, Inc. All rights reserved.</p>
