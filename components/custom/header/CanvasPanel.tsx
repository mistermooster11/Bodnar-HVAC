    ...
    <>
      ...
      <div className="canvas-panel">
        ...
        <p className="canvas-tagline">
          Repair-First HVAC<br />Serving the Mid-Peninsula Since 1976
        </p>
        ...
        <ul className="canvas-contact-list">
          ...
          <li className="canvas-contact-item">
            ...
            <a href="mailto:info@bodnarhvac.com">info@bodnarhvac.com</a>
          </li>
          <li className="canvas-contact-item">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" />
            </svg>
            <span>1251 Fifth Ave., Redwood City, CA 94063</span>
          </li>
        </ul>

        <hr className="canvas-divider" />

        <p className="canvas-license">EPA & BBB Certified | Licensed & Insured</p>
      </div>
    </>
  );
}
