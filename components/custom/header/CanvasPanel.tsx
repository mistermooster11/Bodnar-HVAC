      ...
      <div className="canvas-panel">
        ...
        <ul className="canvas-contact-list">
          ...
          <li className="canvas-contact-item">
            ...
            <a href="mailto:info@carpenter-electric.com">info@carpenter-electric.com</a>
          </li>
          <li className="canvas-contact-item">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" />
            </svg>
            <span>1333 53rd St, West Palm Beach, FL 33407</span>
          </li>
        </ul>

        <hr className="canvas-divider" />

        <p className="canvas-license">License#: EC13011405</p>
      </div>
    </>
  );
}
