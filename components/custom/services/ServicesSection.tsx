    ...
    <section className="services" ref={sectionRef}>
      ...
      <div className="services__header max-w-6xl! mx-auto">
        ...
        <h2 className="services__heading">
          Repair-First HVAC Services for Every Mid-Peninsula Home
        </h2>
        <p className="services__subtext">
          From AC repair to furnace diagnostics to heat pump installation — every service performed personally by John or Ted Bodnar, with honest advice and no commissioned sales pressure.
        </p>
      </div>
