      ...
      <div className="faq__container">
        ...
        <div className="faq__left">
          ...
          <h2 className="faq__heading">
            Common Questions About Bodnar HVAC Services
          </h2>
          <p className="faq__subtext">
            Find clear answers about our Repair-First philosophy, service area, scheduling, warranties, and the brands we service across the Mid-Peninsula.
          </p>
