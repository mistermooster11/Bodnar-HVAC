      ...
      <div className="about__container">
        ...
        <div className="about__content">
          ...
          <h2 className="about__heading">
            50 Years of Hands-On HVAC Expertise
          </h2>
          <p className="about__text">
            Bodnar Heating &amp; Air Conditioning has been the Mid-Peninsula&apos;s trusted HVAC partner since 1976. Three generations of family expertise — but one constant: diagnose first, repair when possible, replace only when necessary.
          </p>
          <p className="about__text">
            Owner John Bodnar handles every repair personally. No commissioned sales reps, no subcontractors. Just an experienced technician who takes pride in getting it right the first time.
          </p>
            ...
            <div className="about__exp-box w-full! md:w-fit! flex! flex-row! gap-10!">
              ...
              <div className="about__exp-content flex flex-row gap-4">
                ...
                <span className="about__exp-text">
                  Years Serving<br />the Mid-Peninsula
                </span>
              </div>
            </div>
          </div>
