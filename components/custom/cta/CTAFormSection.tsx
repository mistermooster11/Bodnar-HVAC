...
export default function CTAFormSection() {
  ...
  const WHY_LEFT = [
    ...
    "Owner-Operated Since 1976",
    "60-Day Labor Warranty",
  ];
  const WHY_RIGHT = [
    "No Commission Sales Reps",
    "Serving 17 Mid-Peninsula Cities",
    "EPA & BBB Certified",
  ];
    ...
    <section className="cta-form" ref={sectionRef}>
      <div className="cta-form__container">
        ...
        <div className="cta-form__left p-10!">
          <div className="cta-form__eyebrow hidden md:block">Why Choose Bodnar?</div>
          <h2 className="cta-form__heading hidden md:block">
            HVAC Service <br />You Can Trust
          </h2>
          <h2 className="cta-form__heading block md:hidden">
            Get in touch
          </h2>
          <p className="cta-form__subtext hidden md:block">
            Owner-operated since 1976 — honest diagnostics, repair-first philosophy,
            <br />60-day labor warranty on every repair.
          </p>
        ...
        <div className="cta-form__right">
          <div className="cta-form__eyebrow">Why Choose Bodnar?</div>
          <h2 className="cta-form__heading">HVAC Service You Can Trust</h2>
          <p className="cta-form__text">
            Bodnar Heating &amp; Air Conditioning has served the Mid-Peninsula since 1976 with a
            Repair-First philosophy. John personally handles every repair — no commissioned sales
            reps, no subcontractors, no upselling.
          </p>
          <p className="cta-form__text">
            We back every repair with a 60-day labor warranty and serve 17 cities across the
            Mid-Peninsula including Redwood City, Palo Alto, Menlo Park, and Atherton.
          </p>
