    ...
    <section className="testimonials" ref={sectionRef}>
      <div className="testimonials__container">
        ...
        <div className="testimonials__header">
          <div className="testimonials__eyebrow">Client Reviews</div>
          <h2 className="testimonials__heading">What Mid-Peninsula Homeowners Say</h2>
          <p className="testimonials__subtext">
            Our clients across Redwood City, Palo Alto, Menlo Park, and 14 other Mid-Peninsula
            cities trust Bodnar HVAC for honest diagnostics, repair-first service, and consistent
